	...
	<div class="large-4 large-centered columns">
		<div class="box no-shadow ">
	        ...
	        <!-- Table -->
	            <div class="row">
	                <div class="large-12 columns">
                      <form method="post" data-abide accept-charset="utf-8" action="<?php echo site_url('reporte-de-cobros') ?>">
                          <h3 class="center"><?php echo lang('formulario.reporte.cobros') ?></h3>
                       <div class="row">
                          ...
                          <div class="large-12 medium-12 small-12 columns">
                             <label>
                                ...
                                <?php echo form_dropdown(array('name'=>'usuario'), $usuarios) ?>
                          ...
                          <div class="large-12 medium-12 small-12 columns">
                             <label>
                                <?php echo lang('fecha.inicio.pago') ?>
                                <input type="text" name="fecha_inicio"  class="select-fecha">
                                <span class="form-error"><?php echo lang('requerido') ?></span>
                             </label>
                          </div>
                          ...
                          <div class="large-12 medium-12 small-12 columns">
                             <label>
                                <?php echo lang('fecha.fin.pago') ?>
                                <input type="text" name="fecha_fin"  class="select-fecha">
                                <span class="form-error"><?php echo lang('requerido') ?></span>
                             </label>
                          </div>
