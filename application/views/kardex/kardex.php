...
class MYPDF extends TCPDF {
    ...
    public function Header()
    {
       ...
       $this->SetY(8);
        ...
        $this->Image(K_PATH_IMAGES.'discapacidad.png', 180, 5, 17, 20, 'PNG', '', '', true, 150, '', false, false, 0, false, false, false);
        $this->Cell(20, 5, '');
        $this->Cell(0, 5, 'Gobierno Autónomo Municipal de Cochabamba', 0, 1);
        $this->Cell(20, 5, '');
        $this->Cell(0, 5, 'Dirección de Género Generacional y Familia', 0, 1);
        $this->Cell(20, 5, '');
        $this->Cell(0, 5, 'Departamento de Desarrollo del Adulto Mayor', 0, 1);
...
if($kardex->foto != null)
   $pdf->Image(FCPATH.'/public/fotos/adultos'.$kardex->foto, 19, 45, 45, 48, 'JPG', '', '', true, 150, '', false, false, 1, false, false, false);
else
...
$html.='
      <table cellpadding="6" cellspacing="2" border="1" style="text-align: justify">
      	<tr style="background-color: #006400;">
              <th><b style="color: #FFFFFF;">I.- IDENTIFICACION PERSONAL, UBICACIÓN Y CONTACTO</b></th>
      	 </tr>
       </table>';
 $pdf->setX(66);
 ...
 $pdf->Cell(87, 8, $kardex->nombres.' '.$kardex->paterno.' '.$kardex->materno, 1, 1, 'C', 0, '', 3);
 ...
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(23, 8, $kardex->genero, 1, 1, 'C', 0, '', 3);

 $pdf->setX(67);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(40, 8, 'Lugar de Nacimiento:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(40, 8, $kardex->lugar_nacimiento, 1, 0, 'C', 0, '', 3);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(25, 8, 'Estado Civil:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(22, 8, $kardex->estado_civil, 1, 1, 'C', 0, '', 3);

 $pdf->setX(67);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(12, 8, 'C.I.:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(25, 8, $kardex->dni, 1, 0, 'C', 0, '', 3);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(12, 8, 'Exp:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(12, 8, $kardex->expedido, 1, 0, 'C', 0, '', 3);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(15, 8, 'E-mail:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(51, 8, $kardex->email, 1, 1, 'C', 0, '', 3);


 $pdf->setX(67);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(40, 8, 'Dirección de Domicilio:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(87, 8, $kardex->direccion, 1, 1, 'C', 0, '', 3);

 $pdf->setX(19);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(15, 8, 'Zona:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(50, 8, $kardex->zona, 1, 0, 'C', 0, '', 3);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(20, 8, 'Distrito:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(10, 8, $kardex->zona, 1, 0, 'C', 0, '', 3);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(20, 8, 'Télefono:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 ...
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(55, 8, $kardex->persona_referencia, 1, 0, 'C', 0, '', 3);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(25, 8, 'Parentesco:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(30, 8, $this->main->getField('familiar', 'familiar', array('id_familiar'=>$kardex->parentesco)), 1, 0, 'C', 0, '', 3);
 $pdf->SetFont('helvetica', 'B', 10, '', true);
 $pdf->Cell(20, 8, 'Télefono:', 1, 0, 'L', 0, '', 3);
 $pdf->SetFont('helvetica', '', 9, '', true);
 $pdf->Cell(20, 8, $kardex->telefono, 1, 0, 'C', 0, '', 3);
 ...
 $pdf->Cell(65, 8, 'DOCUMENTOS CON QUE CUENTA', 1, 1, 'C', 1, '', 3);
 $pdf->SetTextColor(0, 0, 0);
 foreach ($documentos as $documento) {
   $pdf->SetFont('helvetica', '', 8, '', true);
   $pdf->setX(19);
   $pdf->Cell(50, 8, $documento->documento, 1, 0, 'C', 0, '', 3);
   $pdf->SetFont('zapfdingbats', '', 16);
   if($documento->estado === 'DC')
...
$pdf->SetFillColor(21, 94, 21);
$pdf->SetTextColor(255, 255, 255);
$pdf->Cell(50, 8, 'CON QUIEN VIVE', 1, 1, 'C', 1, '', 3);
$pdf->SetTextColor(0, 0, 0);
foreach ($familiares as $familiar) {
  $pdf->SetFont('helvetica', '', 8, '', true);
  $pdf->setX(89);
  $pdf->Cell(35, 8, $familiar->familiar, 1, 0, 'C', 0, '', 3);
  $pdf->SetFont('zapfdingbats', '', 16);
  if($familiar->estado === 'DC')
     $pdf->Cell(15, 8, TCPDF_FONTS::unichr(54), 1, 1, 'C', 0, '', 3);
  else
     $pdf->Cell(15, 8, TCPDF_FONTS::unichr(52), 1, 1, 'C', 0, '', 3);
}
...
// This method has several options, check the source code documentation for more information.*/
$pdf->Output('kardex-discapacitado.pdf', 'I');
//============================================================+
// END OF FILE
//============================================================+
