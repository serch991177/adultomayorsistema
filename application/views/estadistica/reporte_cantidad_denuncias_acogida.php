...
// Establecemos el contenido para imprimir
      ...
      $html .= "</style>";
      $html .= "<h2>Denuncias en Situación de Acogida de la Gestión ".$anio."</h2><h4>Actualmente: ".count($denuncia_acogidas)." Acogidas</h4>";
      ...
      foreach ($denuncia_acogidas as $fila)
      {
        $acog = "Denuncias en Acogidas";
        $cant1 = $fila->y;
        $porcentaje1 = round(($cant1 * 100)/$cant3,2);
      }
      foreach ($denuncia_sin_acogidas as $fila)
      {
        $sin = "Denuncias sin acogidas";
        $cant2 = $fila->sin;
      ...
      $html .= "<tr><center><td align='center' class='instancias'>" . $acog . "</td align='center' ><td class='cantidad'>" . $cant1. "</td><td class='porcentaje'> ".$porcentaje1." %</td></center></tr>";
      $html .= "<tr><center><td align='center' class='instancias'>" . $sin . "</td align='center' ><td class='cantidad'>" . $cant2. "</td><td class='porcentaje'> ".$porcentaje2." %</td></center></tr>";
...
// Este método tiene varias opciones, consulte la documentación para más información.
      ...
      $nombre_archivo = utf8_decode("Denuncias en Situación de Acogida ".$anio.".pdf");
