...
// Establecemos el contenido para imprimir
      ...
      $html .= "</style>";
      $html .= "<h2>Denunciados por Parentesco de la Gestión ".$anio."</h2><h4>Actualmente: ".count($denuncia_instancias)." Acogidas</h4>";
      ...
      foreach ($denuncia_instancias as $fila)
    {
      $den = $fila->name;
      $cant = $fila->y;
      $porcentaje = round(($fila->y * 100)/$total,2);

        $html .= "<tr><center><td align='center' class='instancias'>" . $den . "</td align='center' ><td class='cantidad'>" . $cant. "</td><td class='porcentaje'>" . $porcentaje. " %</td></center></tr>";
    }
