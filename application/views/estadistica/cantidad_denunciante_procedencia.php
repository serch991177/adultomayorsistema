    	                ...
    	                <div class="large-6 columns">
    	                   <div class="">
                               <div class="large-12 small-12 column" style="overflow: hidden; background-color: white !important;">
                                    <div id="denunciantes_procedencia" style="width: 100%; height: 500px; margin: 0 auto"></div>
                                </div>
                            ...
                            <script language="JavaScript">
                                $(document).ready(function() {
                                    ...
                                    var titles = {
                                        text: 'DENUNCIAS POR PROCEDENCIA DE LA GESTION '+<?php echo $anio ?>,
                						style: {
                							color: '#333',
                                    ...
                                    var series= [{
                                        type: 'pie',
                                        name: 'porcentaje ',
                                        data: <?php echo json_encode($denunciantes_procedencia);?>
                                    }];
                                    ...
                                    $('#denunciantes_procedencia').highcharts(json);
                                });
                            </script>
                          </div>
                          <div class="large-6 columns">
                             <div  class="">
                               <div class="box-header panel palette-Brown-500 bg">
                                   ...
                                   <h3 class="box-title"><i class="ti-view-list palette-White-Icons text"></i>
                                       <span class="palette-White-Text text" ><?php echo lang('denuncia.procedencia') .$anio;?></span>
                                   </h3>
                               </div>
                               <!-- Table -->
                     	            <div class="row">
                     	                ...
                     	                <div class="large-12 columns">
                     	                    <table class="stack dinamico" id="denunciante_procedencia">
                     	                        <thead>
                     														<tr>
                     																<th style="text-align:center;"><?php echo lang('numero') ?></th>
                     																<th style="text-align:center;"><?php echo lang('procedencia.denunciante') ?></th>
                     																<th style="text-align:center;"><?php echo lang('cantidad.procedencia.denunciante') ?></th>
                     	                        ...
                     	                        <tbody>
                     															...
                     															<?php foreach ($tabla_denunciantes_procedencia as $denunciante):
                                                    $porcentaje = round(($denunciante->y * 100)/$total,2); ?>
                     																<tr>
                     																	<td style="text-align:center;"><?php echo $numero ?></td>
                     																	<td style="text-align:center;"><?php echo $denunciante->name ?></td>
                     																	<td style="text-align:center;"><?php echo $denunciante->y ?></td>
                                          ...
                                          <div class="large-2 columns large-centered">
                                              <form method="post" data-abide accept-charset="utf-8" action="<?php echo current_url() ?>" />
                                                <button type="submit" name="print_denun_proced" value="1" class="button palette-Brown-500 bg">
