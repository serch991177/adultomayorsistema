...
// Establecemos el contenido para imprimir
      ...
      $html .= "</style>";
      $html .= "<h2>Adultos en Grupos de Terapia Psicológicas de la Gestión ".$anio."</h2><h4>Actualmente: ".count($grupos_terapia)." tipos de Grupos de Terapia Psicológicas</h4>";
      $html .= '<table>';
      $html .= "<tr><th>Grupos de Terapia</th><th>Cantidad</th><th>Porcentaje</th></tr>";
      ...
      foreach($grupos_terapia as $fila)
    {
      $den = $fila->name;
      $cant = $fila->y;
...
// Este método tiene varias opciones, consulte la documentación para más información.
      ...
      $nombre_archivo = utf8_decode("Adultos en Grupos de Terapias ".$anio.".pdf");
