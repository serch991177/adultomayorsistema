    	                ...
    	                <div class="large-6 columns">
    	                   <div class="">
                               <div class="large-12 small-12 column" style="overflow: hidden; background-color: white !important;">
                                    <div id="denuncia_instancias" style="width: 100%; height: 500px; margin: 0 auto"></div>
                                </div>
                            ...
                            <script language="JavaScript">
                                $(document).ready(function() {
                                    ...
                                    var titles = {
                                        text: 'DENUNCIAS REMITIDAS A INSTANCIAS DE ATENCIÓN DE LA GESTIÓN '+<?php echo $anio ?>,
                                    ...
                                    var series= [{
                                        type: 'pie',
                                        name: 'porcentaje ',
                                        data: <?php echo json_encode($denuncia_instancias);?>
                                    }];
                                    ...
                                    $('#denuncia_instancias').highcharts(json);
                                });
                            </script>
                          </div>
                          <div class="large-6 columns">
                             <div  class="">
                               <div class="box-header panel palette-Brown-500 bg">
                                   ...
                                   <h3 class="box-title"><i class="ti-view-list palette-White-Icons text"></i>
                                       <span class="palette-White-Text text" ><?php echo lang('denuncia.instancias') .$anio?></span>
                                   </h3>
                               </div>
                               <!-- Table -->
                     	            <div class="row">
                     	                ...
                     	                <div class="large-12 columns">
                     	                    <table class="stack dinamico" id="denuncia_instancias">
                     	                        <thead>
                     														<tr>
                     																<th style="text-align:center;"><?php echo lang('numero') ?></th>
                     																<th style="text-align:center;"> <?php echo lang('instancias') ?></th>
                     																<th style="text-align:center;"><?php echo lang('cantidad.denuncia.instancia') ?></th>
                     	                        ...
                     	                        <tbody>
                     															...
                     															<?php foreach ($tabla_denuncia_instancias as $instancia):
                                                    $porcentaje = round(($instancia->y * 100)/$total,2);?>
                     																<tr>
                     																	<td style="text-align:center;"><?php echo $numero ?></td>
                     																	<td style="text-align:center;"><?php echo $instancia->name ?></td>
                     																	<td style="text-align:center;"><?php echo $instancia->y ?></td>
