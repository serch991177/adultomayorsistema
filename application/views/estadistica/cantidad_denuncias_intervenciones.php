    	                ...
    	                <div class="large-8 columns">
    	                   <div class="">
                               <div class="large-12 small-12 column" style="overflow: hidden; background-color: white !important;">
                                    <div id="psicologica_visita" style="width: 100%; height: 500px; margin: 0 auto"></div>
                                </div>
                            ...
                            <script language="JavaScript">
                                $(document).ready(function() {
                                    ...
                                    var titles = {
                                        text: 'DENUNCIAS INTERVENCIONES PSICOLÓGICAS DE LA GESTIÓN '+<?php echo $anio ?>,
                          						style: {
                          							color: '#333',
                                    ...
                                    var series= [{
                                        type: 'pie',
                                        name: 'porcentaje ',
                                        data: <?php echo json_encode($psicologica_visita);?>
                                    }];
                                    ...
                                    $('#psicologica_visita').highcharts(json);
                                });
                            </script>
                          </div>
                             ...
                             <div  class="">
                               <div class="box-header panel palette-Brown-500 bg">
                                   ...
                                   <h3 class="box-title"><i class="ti-view-list palette-White-Icons text"></i>
                                       <span class="palette-White-Text text" ><?php echo lang('denuncia.intervencion') .$anio?></span>
                                   </h3>
                               </div>
                               <!-- Table -->
                     	            <div class="row">
                     	                ...
                     	                <div class="large-12 columns">
                     	                    <table class="stack dinamico" id="denuncias_area">
                     	                        <thead>
                     														<tr>
                     																...
                     																<th style="text-align:center;"><?php echo lang('denuncia.intervencion') ?></th>
                     	                        ...
                     	                        <tbody>
                     															...
                     															<?php foreach ($tabla_psicologica_visita as $denuncia):
                                          ...
                                          <div class="large-2 columns large-centered">
                                              <form method="post" data-abide accept-charset="utf-8" action="<?php echo current_url() ?>" />
                                                <button type="submit" name="print_denun_inter" value="1" class="button palette-Brown-500 bg">
