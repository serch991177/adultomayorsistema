...
// Establecemos el contenido para imprimir
      ...
      $html .= "</style>";
      $html .= "<h2>Denuncias por Derivaciones por Áreas Técnicas de la Gestión ".$anio."</h2><h4>Actualmente: ".count($grupos_areas)." tipos de Áreas Técnicas</h4>";

      $html .= '<table>';
      $html .= "<tr><th>Áreas</th><th>Cantidad</th><th>Porcentaje</th></tr>";



      //consulta de victimas por genero
      foreach ($grupos_areas as $fila)
    {
      $den = $fila->name;
      $cant = $fila->y;
