    	                ...
    	                <div class="large-8 columns">
    	                   <div class="">
                               <div class="large-12 small-12 column" style="overflow: hidden; background-color: white !important;">
                                    <div id="tipos_areas" style="width: 100%; height: 500px; margin: 0 auto"></div>
                                </div>
                          ...
                          lang: {
                            ...
                            contextButtonTitle:	"Menú contextual del gráfico",
                                  ...
                                  var series= [{
                                      type: 'pie',
                                      name: 'porcentaje ',
                                      data: <?php echo json_encode($tipos_areas);?>
                                  }];
                             ...
                             <div  class="">
                               <div class="box-header panel palette-Brown-500 bg">
                                   ...
                                   <h3 class="box-title"><i class="ti-view-list palette-White-Icons text"></i>
                                       <span class="palette-White-Text text" ><?php echo lang('denuncia.area') .$anio?></span>
                                   </h3>
                               </div>
                               <!-- Table -->
                     	            <div class="row">
                     	                ...
                     	                <div class="large-12 columns">
                     	                    <table class="stack dinamico" id="denuncias_area">
                     	                        ...
                     	                        <tbody>
                     															...
                     															<?php foreach ($tabla_denuncia_area as $denuncia):
                                          ...
                                          <div class="large-2 columns large-centered">
                                              <form method="post" data-abide accept-charset="utf-8" action="<?php echo current_url() ?>" />
                                                <button type="submit" name="print_denun_derivacion" value="1" class="button palette-Brown-500 bg">
