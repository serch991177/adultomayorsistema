...
// Establecemos el contenido para imprimir
      ...
      $html .= "</style>";
      $html .= "<h2>Denuncias por Intervenciones Sociales de la Gestión ".$anio."</h2><h4>Actualmente: ".count($grupos_intervencion)." tipos de Intervenciones Sociales</h4>";
      $html .= '<table>';
      $html .= "<tr><th>Intervenciones Sociales</th><th>Cantidad</th><th>Porcentaje</th></tr>";
...
// Este método tiene varias opciones, consulte la documentación para más información.
      ...
      $nombre_archivo = utf8_decode("Denunciados por Intervenciones Sociales ".$anio.".pdf");
