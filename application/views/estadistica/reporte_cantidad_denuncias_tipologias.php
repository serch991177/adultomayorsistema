...
// Establecemos el contenido para imprimir
      ...
      $html .= "</style>";
      $html .= "<h2>Victimas por Tipología de Atención de la Gestión ".$anio."</h2><h4>Actualmente: ".count($denuncia_tipologias)." Tipologías con Denuncias Registradas.</h4>";
      $html .= "<table width='100%'>";
      $html .= "<tr><th>Género</th><th>Cantidad</th><th>Porcentaje</th></tr>";



      //consulta de victimas por genero
      foreach ($denuncia_tipologias as $fila)
    {
      $vic = $fila->name;
      $cant = $fila->y;
      $porcentaje = round(($fila->y * 100)/$total,2);

        $html .= "<tr><td class='genero'>" . $vic . "</td><td class='cantidad'>" . $cant. "</td><td class='porcentaje'>" . $porcentaje. " %</td></tr>";
    }
