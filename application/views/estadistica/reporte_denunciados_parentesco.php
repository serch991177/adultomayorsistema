...
// Establecemos el contenido para imprimir
      ...
      $html .= "td{background-color: #CBD0D0; color: #222;text-align: left}";
      $html .= "</style>";
      $html .= "<h2>Denunciados por Parentesco de la Gestión ".$anio."</h2><h4>Actualmente: ".count($denunciados_parentescos)." tipos de Parentescos</h4>";

      $html .= '<table>';
      $html .= "<tr><th>Parentesco</th><th>Cantidad</th><th>Porcentaje</th></tr>";



      //consulta de victimas por genero
      foreach ($denunciados_parentescos as $fila)
    {
      $den = $fila->name;
      $cant = $fila->y;
      $porcentaje = round(($fila->y * 100)/$total,2);

        $html .= "<tr><center><td width='40%' align= class='parentesco'>" . $den . "</td><td class='cantidad'>" . $cant. "</td><td class='porcentaje'>" . $porcentaje. " %</td></center></tr>";
    }
...
// Este método tiene varias opciones, consulte la documentación para más información.
      ...
      $nombre_archivo = utf8_decode("Denunciados por Parentescos ".$anio.".pdf");
