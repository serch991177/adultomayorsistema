...
class Denunciante extends CI_Controller{
  ...
  /**
	...
	public function index()
	{
		...
		//$roles =	$this->main->getListSelect('Ddenunciante', 'id_rol, rol', array('rol'=>'ASC'), array('estado'=>'AC'));
		//$data['roles'] = $this->main->dropdown($roles, '');

		$data['usuarios'] = $this->main->getListOrder('denunciante', array('id_denunciante'=>'ASC'), null, null, null, array('rol'=>'id_rol'));
