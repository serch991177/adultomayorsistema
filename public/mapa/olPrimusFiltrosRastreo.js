        ...
        [
            {
              text: 'Centrar aquí',
              classname: 'bold',
              icon: '/public/mapa/center.png',
              callback: center
            },
            {
              text: 'Operaciones',
              icon: '/public/mapa/view_list.png',
              items: [
                {
                  text: 'Crear marcador',
                  ...
                  callback: function(obj)
                              {
                                 ...
                                 var icono="/public/mapa/pre_foco_defectuoso.png";
                                 var iconFeature = new ol.Feature({
                               ...
                               if (features_aux != null && features_aux.length > 0)
                               {
                                ...
                                dragInteraction.on('modifyend',function(e)
                                {
                                    ...
                                    $('#registrar_subalcaldia').val(datos_cl.nombre_comuna);
                                    $('#registrar_distrito').val(datos_cl.nombre_distrito);
                                    $('#registrar_zona').val(datos_cl.nombre_zona);
                                    $('#registrar_incidente').val(datos_cv.tipo+' '+datos_cv.nombre);
                                    $('#registrar_otb').val(datos_co.nombre);
                                    /*
